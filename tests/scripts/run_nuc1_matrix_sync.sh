...
# Usage (run on NUC1, after setting same START_AT on both NUCs):
# START_AT=$(date -d '+3 minutes' +%H:%M:%S); echo "$START_AT"
# START_AT="$START_AT" IFACE=enp114s0 LOCAL_IP=10.10.27.10 TARGET_IP=10.10.27.11 RUN_SECONDS=120 PAUSE_SECONDS=5 ./tests/scripts/run_nuc1_matrix_sync.sh
